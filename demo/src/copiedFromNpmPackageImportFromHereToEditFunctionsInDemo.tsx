// this file is copied from the source code for the npm package polymorphic-as
// https://github.com/rafgraph/polymorphic-as-prop-api/blob/main/src/index.tsx
// if you want to edit these functions for use in the demo app
// then import from this file instead of the npm package
...
export const polymorphicAsArrayUtil: PolymorphicAsArrayUtil = ({
  ...
  if (process.env.NODE_ENV !== 'production') {
    if (asArray.length === 0) {
      throw new Error(
        'At least 1 `as` needs to be provided to polymorphicAsArrayUtil',
      );
    }
  }
